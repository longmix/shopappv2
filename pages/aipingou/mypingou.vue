<template>
	<view>
					...
					<tr>
						<td>
							<view style="display: flex;">
								...
								<button class="mypingou_button" v-if="aipingou_setting.mypintuan_show_tuanyuan_list == 1" @tap="open_kaijiang_detail(0, 'center',item.tongji_key)">开奖详情</button>
		...
		<openAlert ref="openAlertKaijiang" :AlertClass="AlertClassKaijiang" :AlertPosition="AlertPositionKaijiang">
			<view>
				...
				<view class="tanchuang_list">
					...
					<view style="display: flex;margin-top: 10rpx; border-top: 1rpx solid #d3d7d4;" v-for="(detail,ids) in kaijiang_list"
					 :key="ids">
		...
		<!-- 开奖详情 -->
		<openAlert ref="openAlertZhongjiang" :AlertClass="AlertClassZhongjiang" :AlertPosition="AlertPositionZhongjiang">
			<view>
				<view v-if="zhongjiang_list != 0">
					<view id="zhong">
						<view class="tanchuang_list">
							...
							<view v-for="(items,ida) in zhongjiang_list" :key="ida" style="display: flex;margin-top: 10rpx;border-top: 1rpx solid #d3d7d4;font-size: 30rpx; align-items: center; justify-content: center;text-align: center；">
								<view>{{ida + 1}}</view>
								<view style="margin-left: 68rpx;">
									<image :src="items.headimgurl" style="width: 70rpx; height: 70rpx;"></image>
								</view>
