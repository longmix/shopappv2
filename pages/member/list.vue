							...
							<block v-for="(item,index) in citizen_list" :key="index">
								...
								<view class="aui-extreme-item">
									...
									<view class="server_btn_list">
									    <view href="javascript:;" class="server_btn_style" v-for="(btn_item,btn_index) in item.buttons" :key="btn_index">
	...
	export default {
		data() {
			return {
				...
				citizen_list_url:'http://192.168.0.205/yanyubao_web/yidaozhucan_server/index.php/openapi/UserApi/get_member_list',
				citizen_list :[],
			}
		},
