			...
			<form @submit="formSubmit" @reset="formReset">
				<view class="content">
					<view class="row">
						...
						<view class="input">
							<input placeholder="请输入收件人姓名" type="text" name="name" v-model="address_detail.name" />
						</view>
					</view>
					<view class="row">
						<view class="nominal">
						...
						<view class="input">
							<input placeholder="请输入收件人电话号码" type="text" name="phone" v-model="address_detail.mobile" />
						</view>
					</view>
					<view class="row">
						<view class="nominal">
					...
					<view class="row">
						...
						<view class="input">
							<textarea v-model="address" auto-height="true" name="address" placeholder="输入详细地址"></textarea>
						</view>
					</view>
					<view class="row">
						<view class="nominal">
