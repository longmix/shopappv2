<template>
	<view class="content-list">
		<view class="content-list-hangyi">
			...
			<image src="https://yanyubao.tseo.cn/Tpl/static/images/jiazhenggongsi/男士.png" class="content-list-sex"></image>
		...
		<view class="content_detail_message">
			...
			<view class="content_message01">
				...
				<view class="hang_title">
					<image src="https://yanyubao.tseo.cn/Tpl/static/images/jiazhenggongsi/书.png" class="content-list-img01"></image>
					<view class="hang_content">文化程度：{{education}}</view>
				</view>
				<!-- <view class="hang_title">
					<image src="https://yanyubao.tseo.cn/Tpl/static/images/jiazhenggongsi/书.png" class="content-list-img01"></image>
				...
				<view class="content_middle_title">
					<view class="blue_gang"></view>
					<view class="content_title_wenzi">专管人员</view>
				</view>
				<view class="hang_title">
					<image src="https://yanyubao.tseo.cn/Tpl/static/images/jiazhenggongsi/书.png" class="content-list-img01"></image>
					<view class="hang_content">所属专管：赵钱孙</view>
				</view>
				<view class="hang_title">
					<image src="https://yanyubao.tseo.cn/Tpl/static/images/jiazhenggongsi/书.png" class="content-list-img01"></image>
					<view class="hang_content">监管情况</view>
				</view>
				<view class="content_beizhu">砸砸砸砸砸砸砸砸砸砸砸砸砸砸</view> 
				
				<view class="content_middle_title">
					<view class="blue_gang"></view>
					<view class="content_title_wenzi">为以下客户服务</view>
				</view>
				<view v-for="(item , index) in fuwu_citizen_list" :key="index">
					<view style="margin-top: 20rpx;">{{item.name}}</view>
					<view class="content_xuxian"></view>
				</view>
			</view>
			<view class="content_fanhui">
				<view style="color: #F0F3F6;font-size: 36rpx;" @tap="back_worker_list">返&nbsp;&nbsp;&nbsp;&nbsp;回</view>
			</view>
			<view class="loading">
				{{ is_ok }}
			</view>
