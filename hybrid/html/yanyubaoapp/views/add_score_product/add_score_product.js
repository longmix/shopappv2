...
angular.module("add_score_product",[])

    .controller("add_score_product",function($scope,$http,$state,$ionicLoading,$timeout,$ionicViewSwitcher,$stateParams,$ionicActionSheet){
   ...
   $scope.upload_product=function(){
           ...
           $http({
                   method: 'post',//请求方式
                   url:http_server+"/index.php?g=Yanyubao&m=Shang&a=score_product_add",//请求地址
  ...
  if (caozuo == 'update') {
          ...
          $http({
                   method: 'post',//请求方式
                   url:http_server+"/index.php?g=Yanyubao&m=Shang&a=score_product_detail",//请求地址
                   data: { 'sellerid':login_obj.sellerid,
                           'checkstr':login_obj.checkstr,
                           'productid':productid
