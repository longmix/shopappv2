...
angular.module("my_dingdan",[])

    .controller("my_dingdan",function($scope,$http,$state,$ionicLoading,$timeout,$ionicViewSwitcher,$ionicViewSwitcher){
      ...
      //获取店铺基本信息
        $scope.get_order_list = function(){
        	...
        	$http({
                method: 'post',//请求方式
                url: http_server+"/index.php?g=Yanyubao&m=Shang&a=order_list",//请求地址
